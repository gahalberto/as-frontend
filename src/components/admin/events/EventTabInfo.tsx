...
export const EventTabInfo = ({ event, refreshAction }: Props) => {
    ...
    const eventSchema = z.object({
        titleField: z.string().min(1, 'Complete the title'),
        descriptionField: z.string().min(1, 'Complete the description'),
    ...
    return(
        <div className="my-3">
            ...
            <div className="flex-1">
                ...
                <div className="flex-1">
                    <label>Event is Avalaible?</label>
                    <input 
                        type="checkbox"
                        checked={statusField}
